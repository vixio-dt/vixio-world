    ...
    return (
      <div className="mx-auto max-w-4xl">
        ...
        <p className="mb-6 text-slate-600">
          Found {totalFound} entities. Review and select which ones to create in <strong>{worldName}</strong>.
        </p>

        {error && (
          <div className="mb-4 rounded-lg bg-red-500/10 p-4 text-red-600">
            {error}
          </div>
        )}
